  ...
  <div id="content" class="tab-content active" data-tabid="tab1"><div id="login-wrapper">
    <div id="login-form">
      <div id="login-form-form">
        ...
        <div class="b-content">
          <span class="b-text b-text_lang_en">Site mycheckin.pixellion.ru just created.</span>
          <span class="b-text b-text_lang_ru">Сайт mycheckin.pixellion.ru только что создан.</span>
          <br/>
